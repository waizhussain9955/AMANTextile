    ...
    <div class="container">
      <div class="row" style="margin-bottom: 40px; align-items: flex-start;">
        ...
        <div class="col-lg-4 col-md-12 footer-anim" style="margin-bottom: 30px;">
          <a href="index.html" style="display: block; margin-bottom: 30px;">
            <img src="assets/images/AT_LOGO_DARK-removebg.png" style="width: 140px; height: auto; display: block; margin-top: -15px; transition: transform 0.3s ease;" alt="AMAN Textile" />
          </a>
        ...
        <!-- Column 2: Contact -->
        <div class="col-lg-4 col-md-6 footer-anim" style="margin-bottom: 30px;">
...
files.forEach(f => {
  ...
  if (content !== before) {
    ...
    console.log('Fixed perfect footer alignment in ' + f);
  }
});
