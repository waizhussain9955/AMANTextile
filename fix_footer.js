...
const newFooter = `  <footer class="awam-elementor-footer footer-4264" style="background: #ffffff; padding: 80px 0 0 0; color: #333333; font-family: 'Poppins', sans-serif; border-top: 1px solid #eaeaea;">
    <div class="container">
      <div class="row" style="margin-bottom: 50px;">
        <!-- Column 1: Logo & Social -->
        <div class="col-lg-4 col-md-12 wow fadeInUp" data-wow-delay="0.1s" style="margin-bottom: 30px;">
          <a href="index.html">
            <img src="assets/images/AT_LOGO_DARK.png" alt="AMAN Textile" style="max-height: 95px; width: auto; margin-bottom: 30px; transition: transform 0.3s ease;">
          </a>
    ...
    <!-- Copyright Bar -->
    <div style="background: #010a29; color: rgba(255,255,255,0.7); padding: 25px 0; text-align: center; font-size: 13px; letter-spacing: 1px;">
